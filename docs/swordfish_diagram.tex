...
%  text width=3cm, 	% max text width
 ...
 \begin{tabular}{l}
   ...
   \parbox{3cm}{$\simeq$ equal geodesic distance contours}
 \end{tabular}
 };
...
%  anchor=center
 ...
 {%
 \begin{tabular}{l}
   \parbox{4cm}{\textbf{Experimental design}}
 \end{tabular}
 };
...
%  anchor=center
 ...
 {%
 \begin{tabular}{l}
   \parbox{5cm}{\textbf{Effective counts method}}\\
   $\mathcal{I}_{ij}(\theta) \to \left(s_i(\theta), b_i(\theta)\right)$
 \end{tabular}
 };
